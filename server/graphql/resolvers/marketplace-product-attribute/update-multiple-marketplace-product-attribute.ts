...
export const updateMultipleMarketplaceProductAttribute = {
    async updateMultipleMarketplaceProductAttribute(_: any, { patches }, context: any) {
        let results = []
        ...
        if (_updateRecords.length > 0) {
            for (let i = 0; i < _updateRecords.length; i++) {
              ...
              const marketplaceProductAttribute = await marketplaceProductAttributeRepo.findOne(newRecord.id)
